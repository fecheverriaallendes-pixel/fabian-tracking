...
const firebaseConfig = {
  apiKey: process.env.VITE_FIREBASE_API_KEY || "AIzaSyATZn1U1B_JywQkdSrVxQ-_K4C5Q82KxCE",
  authDomain: process.env.VITE_FIREBASE_AUTH_DOMAIN || "fabian-tracking.firebaseapp.com",
  projectId: process.env.VITE_FIREBASE_PROJECT_ID || "fabian-tracking",
  storageBucket: process.env.VITE_FIREBASE_STORAGE_BUCKET || "fabian-tracking.firebasestorage.app",
  messagingSenderId: process.env.VITE_FIREBASE_MESSAGING_SENDER_ID || "108032115841",
  appId: process.env.VITE_FIREBASE_APP_ID || "1:108032115841:web:7f1236ab5a8a715c83b980"
};
